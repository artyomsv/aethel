...
For deeper architectural rationale see [docs/architecture.md](docs/architecture.md) (30 ADRs cover every meaningful decision).
...
| Question | Doc |
|---|---|
| How does Quil work internally? | [docs/architecture.md](docs/architecture.md) — 30 ADRs |
