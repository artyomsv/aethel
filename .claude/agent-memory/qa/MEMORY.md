...
- [project_mutation_probe_on_a_copy.md](project_mutation_probe_on_a_copy.md) — probing on a scratchpad copy: line endings vary PER FILE so assert the mutation applied, separate build breaks from kills, pin restores to a SHA
...
- [project_sandbox_wiring_gaps.md](project_sandbox_wiring_gaps.md) — feat/docker-sandbox: pure internal/sandbox well pinned, every daemon+TUI call site unpinned; 15/25 mutations survived, incl. deleting the host-spawn refusal
