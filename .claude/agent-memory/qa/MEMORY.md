...
- [project_ingest_arrival_order_gaps.md](project_ingest_arrival_order_gaps.md) — PR #199: Ingester.Cancel's order-list removal is mutation-survivable; the TUI subagent branch keys on the CLASSIFIED kind, so it fires for all four types mapping to WorkEventStop
